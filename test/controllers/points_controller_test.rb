...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { latitude: @point.latitude, longitude: @point.longitude, map_id: @point.map_id, name: @point.name, remark: @point.remark } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { latitude: @point.latitude, longitude: @point.longitude, map_id: @point.map_id, name: @point.name, remark: @point.remark } }
